...
<%
	...
	int price = request.getParameter("price").isEmpty() ? 0 : Integer.parseInt(request.getParameter("price"));
	String author = request.getParameter("author");
	String description = request.getParameter("description");
	String publisher = request.getParameter("publisher");
	String category = request.getParameter("category");
	long quantity = request.getParameter("quantity").isEmpty() ? 0 : Long.parseLong(request.getParameter("quantity"));
